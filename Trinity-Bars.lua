...
-- GIT-HUB PATH
local GIT_REP_AND_NAME = "Trinity-Bars"
...
local TEXTURES = {	-- NAME, URL
	["FOOD"] = {"food.png", "https://github.com/eweest/Trinity-Bars/raw/main/assets/textures/food.png"},
	["WATER"] = {"water.png", "https://github.com/eweest/Trinity-Bars/raw/main/assets/textures/water.png"},
	["HYGIENE"] = {"hygiene.png", "https://github.com/eweest/Trinity-Bars/raw/main/assets/textures/hygiene.png"},
	-- STYLE 2
	["FOOD_1"] = {"food-1.png", "https://github.com/eweest/Trinity-Bars/raw/main/assets/textures/food-1.png"},
	["WATER_1"] = {"water-1.png", "https://github.com/eweest/Trinity-Bars/raw/main/assets/textures/water-1.png"},
	["HYGIENE_1"] = {"hygiene-1.png", "https://github.com/eweest/Trinity-Bars/raw/main/assets/textures/hygiene-1.png"}
...
function main()
	...
	sampRegisterChatCommand("bars", function(cmd) -- HELP
		...
		elseif (cmd == "update" or cmd == "up") then -- UPDATE
			...
			-- reloadScript()
		-- ERROR MSG
		elseif #cmd == 0 then -- DONE CMD
			cmdHelpCMD()
			addOneOffSound(0.0, 0.0, 0.0, 1139)
		else
			if cmd:find("^type") then -- ERROR TYPE
				addOneOffSound(0.0, 0.0, 0.0, SOUNDS["ERROR"])
				sampAddChatMessage(TAG .."{FFFFFF}Неизвестная команда. Введите: {FFCC00}" .. CMD_HELP .. " type (1-3)", COLOR_CHAT["ERROR"])
			elseif cmd:find("^icons") then -- ERROR ICONS
				addOneOffSound(0.0, 0.0, 0.0, SOUNDS["ERROR"])
				sampAddChatMessage(TAG .."{FFFFFF}Неизвестная команда. Введите: {FFCC00}" .. CMD_HELP .. " icons (1-2)", COLOR_CHAT["ERROR"])
			else -- ERROR CMD
			addOneOffSound(0.0, 0.0, 0.0, SOUNDS["ERROR"])
...
{AFE7FF}Название (Версия){ffffff}			TRINITY Bars {AFE7FF}(v1.3){ffffff}
{AFE7FF}Автор скрипта{ffffff}				eweest
{AFE7FF}Наше сообщество{ffffff}				vk.com/gtatrinitymods

{AFE7FF}Дата последнего обновления{ffffff}		04.06.2022
]=]
...
function cmdHelpCMD()
	sampShowDialog(10000, TITLE_COLOR .. TITLE .. thisScript().name, TEXT_CMD .. TEXT_AUPDATE, "X")
end
-- HELP WINDOW [END]
